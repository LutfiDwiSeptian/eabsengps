<form action="/karyawan/{{ $karyawan->nik}}/update" method="POST" id="form-inputkaryawan" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row">
                    <div class="mb-3">
                        <textarea class="form-control" rows="5" placeholder="Alamat" id="alamat" name="alamat">{{ $karyawan->alamat }}</textarea>
                      </div>
                    </div>
                    <!-- <div class="row mt-2">
                        <div class="col-12">
                    ...
                    <div class="row mt-2">
                        ...
                        <select name="kode_dept" id="kode_dept" class="form-select">
                                <option value="{{ $karyawan->kode_dpt }}">Department</option>
                                @foreach ($department as $d)
                                <option {{ $karyawan->kode_dpt == $d->kode_dept ? 'selected' : '' }} value="{{ $d->kode_dept }}">{{ $d->nama_dept }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
