                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="nama_karyawan"  placeholder="Nama Karyawan" name="nama_karyawan" value="{{ Request('nama_karyawan')}}">
                                            </div>
                                        </div>
                                        <div class="row mt-2">
                                            <div class="col-12">
                                        ...
                                        <div class="col-2 mt-2">
                                            <div class="form-group">
                                                <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-inputkaryawan">
                        ...
                        @foreach ($karyawan as $d)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="/karyawan/{{ $d->nik }}/delete" method="POST" id="form-deletekaryawan">
                                        @csrf
                                        @method('DELETE')
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <table class="table table-bordered">
                <form action="{{ url('/karyawan/store') }}" method="POST" id="form-inputkaryawan" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row">
                    <div class="mb-3">
                        <textarea class="form-control" rows="5" placeholder="Alamat" id="alamat" name="alamat"></textarea>
                      </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-12">
